"""
Demo dataset containing realistic multi-turn sales email conversations,
urgency evaluations, buying signals, and pre-computed RAG metadata.
"""
...
DEMO_LEADS: List[Dict[str, Any]] = [
    {
        ...
        "deal_size": "$48,000 / yr",
        "reason": "Prospect requested pricing 3 days ago after a successful demo. Sales rep promised a quote 'by tomorrow morning' but never sent it. Rahul sent a follow-up asking for updates.",
        "next_action": "Follow up immediately with the customized pricing tier breakdown and apologize for the delay.",
        "signals": {
    ...
    },
    {
        ...
        "deal_size": "$24,000 / yr",
        "reason": "Sarah mentioned they were reviewing internal sales workflows this week and asked to reconnect mid-week.",
...
def get_demo_lead_by_id(lead_id: str):
